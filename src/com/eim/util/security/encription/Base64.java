...
/**
 * This class provides some basic functionality to encode/decode byte arrays into strings, using
 * the base64 representation (or some kind of it).
 *
 * @author als
 */
public class Base64 {
	...
	/**
	 * Gets the instance attribute of the Base64 class
	 *
	...
	/**
	 * Gets the char attribute of the Base64 object
	 *
	 * @param sixBit Description of the Parameter
	 *
	...
	/**
	 * Gets the value attribute of the Base64 object
	 *
