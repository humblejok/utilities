/**
 * Title           : $Workfile: InvalidLongValueException.java $
 * Copyright       : EIM (c) 2004
 * Updates         : $Date: 31.05.06 17:39 $
 * By              : $Author: Sdj $
 * Version number  : $Revision: 3 $
 *
 * $History: InvalidLongValueException.java $
 * 
 * *****************  Version 3  *****************
 ...
 * @author  als
 */
public class InvalidLongValueException
	extends InvalidDataException
{
	...
	private static final long serialVersionUID = -2460162249828890729L;

	/**
	 * Creates a new InvalidLongValueException object.
	 */
...
} // end class InvalidLongValueException
