/**
 * Title           : $Workfile: StartBuildEventMsciInformationEvent.java $
 ...
 * @author als
 */
public class StartBuildEventMsciInformationEvent
	extends MsciImporterEvent {
	protected int eventNb;

	/**
	 * Creates a new StartBuildEventMsciInformationEvent object.
	 *
	 * @param eventNb DOCUMENT ME!
	 */
	public StartBuildEventMsciInformationEvent( int eventNb ) {
