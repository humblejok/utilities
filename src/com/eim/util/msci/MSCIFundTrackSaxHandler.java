/**
 * Title           : $Workfile: MSCIFundTrackSaxHandler.java $
...
public class MSCIFundTrackSaxHandler extends DefaultHandler {
	 ...
	 */
	public MSCIFundTrackSaxHandler( ArrayList listeners ) {
		super();
		loadAllFunds   = true;
	 ...
	 * @param  listeners   DOCUMENT ME!
	 */
	public MSCIFundTrackSaxHandler(
	  String    msciFundId,
	  ArrayList listeners ) {
		super();
		loadAllFunds = false;
	...
	public void characters(
	  ...
	  int    length )
		...
		if( !skipCurrentFund ) {
			...
			if( (currentFundNode != null) && (nodePathStack.contains( MSCIFundNodeNames.NODE_PERFORMANCE_DATA ) || nodePathStack.contains( MSCIFundNodeNames.NODE_LEGAL_NAME ) || nodePathStack.contains( MSCIFundNodeNames.NODE_PERFORMANCE_DATA )) ) {
	...
	public void endElement(
	  ...
	  String qName )
		...
		if( MSCIFundNodeNames.NODE_MSCI_HEDGE_FUND_INFO.equals( qName ) ) {
			...
			if( MSCIFundNodeNames.NODE_PERFORMANCE_DATA.equals( qName ) || MSCIFundNodeNames.NODE_MSCI_FUND_CODE.equals( qName ) || MSCIFundNodeNames.NODE_LEGAL_NAME.equals( qName ) || nodePathStack.contains( MSCIFundNodeNames.NODE_PERFORMANCE_DATA ) ) {
				currentFundNode = currentFundNode.getParentNode();
			} else {
				// nothing to do
			}
