/**
 * Title           : $Workfile: ArraysUtil.java $
 * Copyright       : EIM (c) 2004
 * Updates         : $Date: 10.11.04 17:51 $
 * By              : $Author: Als $
 * Version number  : $Revision: 3 $
 *
 * $History: ArraysUtil.java $
 * 
 * *****************  Version 3  *****************
 * User: Als          Date: 10.11.04   Time: 17:51
 ...
 *
 * @author   $author$
 * @version  $Revision: 3 $, $Date: 10.11.04 17:51 $
 */
...
public final class ArraysUtil {
	...
	/**
	 * <p>ArrayUtils instances should NOT be constructed in standard programming. Instead, the class
	 * should be used as <code>ArrayUtils.clone(new int[] { 2} )</code>.</p>
	 *
	 ...
	 *
	 * <p>The objecs in the array are not cloned, thus there is no special handling for
	...
	/**
	 * <p>Checks if a value falling within the given tolerance is in the given array.  If the array
	 ...
	 *
	 * @return  the index of the object within the array, <code>-1</code> if not found or <code>
	 *          null</code> array input
	 */
	 ...
	 * @param   valueToFind  the value to find
	 *
	 * @return  the index of the value within the array, <code>-1</code> if not found or <code>
	 *          null</code> array input
	 */
	public static int indexOf(
	  final long[] array,
	 ...
	 *
	 * @return  the index of the object within the array starting at the index, <code>-1</code> if not
	...
	/**
	 * <p>Find the index of the given value within a given tolerance in the array. This method will
	 * return the index of the first value which falls between the region defined by valueToFind -
	 * tolerance and valueToFind + tolerance.</p>
	 *
	 * <p>This method returns <code>-1</code> if <code>null</code> array input.</p>
	 *
	 * @param   array        the array to search through for the object, may be <code>null</code>
	...
	/**
	 * <p>Find the index of the given value in the array starting at the given index. This method will
	 * return the index of the first value which falls between the region defined by valueToFind -
	 * tolerance and valueToFind + tolerance.</p>
	 *
	 * <p>This method returns <code>-1</code> if <code>null</code> array input.</p>
	 ...
	 * <p>This method returns <code>-1</code> if <code>null</code> array input.</p>
	 *
	 * @param   array         the array to travers backwords looking for the object, may be <code>
	 *                        null</code>
	 * @param   objectToFind  the object to find, may be <code>null</code>
	 *
	 * @return  the last index of the object within the array, <code>-1</code> if not found or <code>
	 *          null</code> array input
	 */
	 ...
	 *
	 * @return  the last index of the value within the array, <code>-1</code> if not found or <code>
	 *          null</code> array input
	 */
	public static int lastIndexOf(
	  final long[] array,
	 ...
	 * <p>This method returns <code>-1</code> if <code>null</code> array input.</p>
	 *
	 * <p>A negative startIndex will return <code>-1</code>. A startIndex larger than the array
	 * length will search from the end of the array.</p>
	 *
	 * @param   array         the array to traverse for looking for the object, may be <code>
	 *                        null</code>
	 * @param   objectToFind  the object to find, may be <code>null</code>
	 ...
	 * <p>This method returns <code>-1</code> if <code>null</code> array input.</p>
	 *
	 * <p>A negative startIndex will return -1. A startIndex larger than the array length will
	 * search from the end of the array.</p>
	 *
	 * @param   array        the array to traverse for looking for the object, may be <code>
	 *                       null</code>
	 * @param   valueToFind  the value to find
	...
	/**
	 * <p>Find the last index of the given value within a given tolerance in the array. This method
	 * will return the index of the last value which falls between the region defined by
	 * valueToFind - tolerance and valueToFind + tolerance.</p>
	 *
	 * <p>This method returns <code>-1</code> if <code>null</code> array input.</p>
	 *
	 * @param   array        the array to search through for the object, may be <code>null</code>
	...
	/**
	 * <p>Find the last index of the given value in the array starting at the given index. This method
	 * will return the index of the last value which falls between the region defined by
	 * valueToFind - tolerance and valueToFind + tolerance.</p>
	 *
	 * <p>This method returns <code>-1</code> if <code>null</code> array input.</p>
	 ...
	 * @return  a <code>byte</code> array, <code>null</code> if null array input
	 */
	public static short[] toPrimitive(
	  final Short[] array,
	 ...
	 * @return  a <code>byte</code> array, <code>null</code> if null array input
	 */
	public static byte[] toPrimitive(
	  final Byte[] array,
	 ...
	 * @return  a <code>float</code> array, <code>null</code> if null array input
	 */
	public static float[] toPrimitive(
	  final Float[] array,
	 ...
	 * @return  a <code>boolean</code> array, <code>null</code> if null array input
	 */
	public static boolean[] toPrimitive(
	  final Boolean[] array,
	...
	// -----------------------------------------------------------------------
	/**
	 * <p>Checks whether two arrays are the same length, treating <code>null</code> arrays as length
	 * <code>0</code>.
	 *
	 ...
	 *
	 * @return  <code>true</code> if length of arrays matches, treating <code>null</code> as an empty
	 *          array
	 */
	public static boolean isSameLength(
	  final Object[] array1,
	  final Object[] array2 ) {
	...
	/**
	 * <p>Checks whether two arrays are the same type taking into account multi-dimensional
	 * arrays.</p>
	 *
